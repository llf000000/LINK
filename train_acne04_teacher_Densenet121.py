...
from models.II-SKD.densenet121.custom_densenet121_II-SKD import CustomDenseNet121
from models.II-SKD.resnet34.custom_resnet34_II-SKD import CustomResNet34
...
def parse_args():
    ...
    parser.add_argument('--distance_weight', default=25, type=int)
    parser.add_argument('--angle_weight', default=50, type=int)
    ...
    parser.add_argument('--teacher_weight_root', default="/root/autodl-tmp/checkpoint/teacher/2024-12-22_17:15:26_cifar10_train_acne04_teacher_googlenet_0.7911/cross_val_index_0_model_best.pth", type=str)
...
def main(cross_val_index,args):
    ...
    student = CustomDenseNet121(pretrained=True,num_classes=4,M = args.M)
    ...
    for epoch in range(args.epochs):
        ...
        for step, data in enumerate(train_bar):
            ...
            logits_student,_,_  = student(images.to(args.device))

            loss_ce = F.cross_entropy(logits_student, labels.to(args.device))
            
            # 计算整个批次的平均RKD损失
            loss = args.ce_loss_weight*loss_ce
